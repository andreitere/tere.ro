...
description: "Data Processing using Gemini Models - My first talk at a GDG Meetup. Join me as I explore the fascinating journey of transforming physical documents into structured JSON data using Google's Gemini Models. Learn about the challenges, solutions, and real-world applications of AI-powered document processing."
date: "2024-09-29"
categories: ["talks"]
draft: false
external: false
...
<img src="https://tere-ro.b-cdn.net/tere.ro/gdg-article-2024/gdg_tere_intro.jpeg" class="w-full" />

> 🧑🏻‍💻 [Code](https://github.com/andreitere/gdg_expense_vertex_ai) | 🖥️ [Presentation](https://andreitere.github.io/gdg_expense_vertex_ai/)
