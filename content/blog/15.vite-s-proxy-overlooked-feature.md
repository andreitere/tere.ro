...
For more Vue 3 and modern development tooling guides:

- **[Firebase Web Notifications Setup](/vue/firebase-web-notifications-tutorial-2023)** - Real-world Vite configuration with production builds and environment variables
- **[Pinia Setup Stores Guide](/vue/pinia-setup-stores)** - Modern state management patterns for Vue 3 applications
