...
```js
export const [useLoading](/vue/vue3-vuex-4-loading-wait) = defineStore('loading', () => {
  const queue = ref([])
  function add(el) {
...
## Related Vue Development Articles

For more Vue 3 state management and tooling guides:

- **[Vuex4 Loading States Module](/vue/vue3-vuex-4-loading-wait)** - If you're still using Vuex and want to see the differences
- **[Vite's Proxy Configuration](/development/vite-s-proxy-overlooked-feature)** - Essential development environment setup for Vue apps
