...
For modern Vue 3 development patterns:

- **[Pinia Setup Stores Guide](/vue/pinia-setup-stores)** - Migration path from Vuex to the new Vue 3 state management standard
- **[Firebase Web Notifications Setup](/vue/firebase-web-notifications-tutorial-2023)** - Complex state management scenarios with external services
